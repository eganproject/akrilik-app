  <!-- Footer -->
    ...
    <!-- Floating Whatsapp -->
    <a href="https://wa.me/6285385136547" target="_blank" aria-label="Chat via Whatsapp" class="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center bg-[#25D366] hover:bg-[#20bd5a] text-white rounded-full shadow-2xl transition-all duration-300 hover:shadow-green-500/50 hover:-translate-y-1 group animate-float">
